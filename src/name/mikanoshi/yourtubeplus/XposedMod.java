...
public class XposedMod implements IXposedHookLoadPackage {
	...
	byte[] getEndpoint(ClassLoader clsldr, String pane) {
		Object paneObj = XposedHelpers.callStaticMethod(XposedHelpers.findClass("ssm", clsldr), "a", pane);
		return (byte[])XposedHelpers.callStaticMethod(XposedHelpers.findClass("ahgn", clsldr), "toByteArray", paneObj);
	}
/*	
	...
	public void hookEverything(final LoadPackageParam lpparam) {
		...
		findAndHookMethod("com.google.android.apps.youtube.app.WatchWhileActivity", lpparam.classLoader, "a", Intent.class, boolean.class, new XC_MethodHook() {
			...
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
				...
				intent.putExtra("navigation_endpoint", getEndpoint(lpparam.classLoader, "FElibrary"));
...
/*		
		...
		findAndHookMethod("edz", lpparam.classLoader, "R", new XC_MethodHook() {
			@Override
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
			}
		});
*/
		...
		try {
			findAndHookMethod("rkv", lpparam.classLoader, "a", int.class, deviceSupportHook);
			findAndHookMethod("rkv", lpparam.classLoader, "a", Context.class, int.class, deviceSupportHook);
		} catch(Throwable t)  {
			XposedBridge.log(t);
		}
		...
		// Video ended
		findAndHookMethod("eqg", lpparam.classLoader, "R", new XC_MethodHook() {
			@Override
			protected void afterHookedMethod(MethodHookParam param) throws Throwable {
				prefs.reload();
		...
		findAndHookMethod("eqg", lpparam.classLoader, "Q", new XC_MethodHook() {
			@Override
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
...
*/
		...
		findAndHookMethod("zkc", lpparam.classLoader, "a", Class.class, Object.class, int.class, new XC_MethodHook() {
			@Override
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
		...
		findAndHookMethod("hcj", lpparam.classLoader, "a", "sxa[]", int.class, new XC_MethodHook() {
			@Override
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
				if (sNewVideo) {
					sNewVideo = false;
...
/*
		...
		findAndHookMethod("fff", lpparam.classLoader, "n", new XC_MethodHook() {
			@Override
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
				int x = ((Enum<?>)getObjectField(getObjectField(param.thisObject, "ar"), "a")).ordinal();
		...
		findAndHookMethod("fff", lpparam.classLoader, "onClick", View.class, new XC_MethodHook() {
			@Override
			protected void afterHookedMethod(MethodHookParam param) throws Throwable {
				XposedBridge.log("fff onClick() " + ((View)param.args[0]).toString());
			}
		});
*/
	}
